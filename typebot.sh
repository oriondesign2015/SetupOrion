...
echo ""
echo "Versão: $version"
echo "Link do Builder: $builder"
echo "Porta do Builder: $portabuilder"
echo "Link do Viewer: $viewer"
echo "Porta do Viewer: $portaviewer"
echo "Link do Storage: $storage"
echo "Porta do Storage: $portastorage"
echo "Seu Email: $email"
echo "Senha do seu Email: $senha"
echo "SMTP do seu email: $smtp"
echo "Porta SMTP: $portasmtp"
echo "SMTP_SECURE: $SECURE"
echo "Chave secreta: $key"
echo ""
echo ""
