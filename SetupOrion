...
versao() {
echo -e "                                   \e[97mVersão do SetupOrion: \e[32mv. 2.6.3\e[0m                                  "
...
menu_instalador_pg_2(){
    echo -e "${amarelo}[ 46 ]${reset} - ${branco}HumHub ${verde}[1/1]${reset}                           ${verde}| ${reset}  ${amarelo}[ 69 ]${reset} - ${branco}Frappe ${verde}[2/4]${reset} ${verde}[NOVO]${reset}"
    echo -e "${amarelo}[ 47 ]${reset} - ${branco}Yourls ${verde}[1/1]${reset}                           ${verde}| ${reset}  ${amarelo}[ 70 ]${reset} - ${branco}Bolt ${verde}[1/1]${reset} ${verde}[NOVO]${reset}"
    echo -e "${amarelo}[ 48 ]${reset} - ${branco}TwentyCRM${vermelho} ${verde}[1/4]${reset}                        ${verde}| ${reset}  ${amarelo}[ 71 ]${reset} - ${branco}WiseMapping ${verde}[1/1]${reset} ${verde}[NOVO]${reset}"
    echo -e "${amarelo}[ 49 ]${reset} - ${branco}Mattermost ${verde}[1/1]${reset}                       ${verde}| ${reset}  ${amarelo}[ 72 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 50 ]${reset} - ${branco}Outline ${verde}[1/1]${reset}                          ${verde}| ${reset}  ${amarelo}[ 73 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 51 ]${reset} - ${branco}Focalboard ${verde}[1/1]${reset}                       ${verde}| ${reset}  ${amarelo}[ 74 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 52 ]${reset} - ${branco}GLPI ${verde}[1/1]${reset}                             ${verde}| ${reset}  ${amarelo}[ 75 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 53 ]${reset} - ${branco}Anything LLM ${verde}[1/1]${reset}                     ${verde}| ${reset}  ${amarelo}[ 76 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 54 ]${reset} - ${branco}Excalidraw ${verde}[1/1]${reset}                       ${verde}| ${reset}  ${amarelo}[ 77 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 55 ]${reset} - ${branco}Easy!Apointments ${verde}[1/1]${reset}                 ${verde}| ${reset}  ${amarelo}[ 78 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 56 ]${reset} - ${branco}Documenso ${verde}[1/1]${reset}                        ${verde}| ${reset}  ${amarelo}[ 79 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 57 ]${reset} - ${branco}Moodle ${verde}[1/1]${reset}                           ${verde}| ${reset}  ${amarelo}[ 80 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 58 ]${reset} - ${branco}ToolJet ${verde}[2/4]${reset}                          ${verde}| ${reset}  ${amarelo}[ 81 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 59 ]${reset} - ${branco}Stirling PDF ${verde}[1/1]${reset}                     ${verde}| ${reset}  ${amarelo}[ 82 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 60 ]${reset} - ${branco}ClickHouse ${verde}[1/1]${reset}                       ${verde}| ${reset}  ${amarelo}[ 83 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 61 ]${reset} - ${branco}RedisInsight ${verde}[1/1]${reset}                     ${verde}| ${reset}  ${amarelo}[ 84 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 62 ]${reset} - ${branco}Traccar ${verde}[1/1]${reset}                          ${verde}| ${reset}  ${amarelo}[ 85 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 63 ]${reset} - ${branco}Firecrawl ${verde}[1/1]${reset}                        ${verde}| ${reset}  ${amarelo}[ 86 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 64 ]${reset} - ${branco}Wuzapi ${verde}[1/1]${reset}                           ${verde}| ${reset}  ${amarelo}[ 87 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 65 ]${reset} - ${branco}krayin CRM ${verde}[1/1]${reset}                       ${verde}| ${reset}  ${amarelo}[ 88 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 66 ]${reset} - ${branco}Planka ${verde}[1/1]${reset} ${verde}[NOVO]                    ${verde}| ${reset}  ${amarelo}[ 89 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 67 ]${reset} - ${branco}WppConnect ${verde}[1/1]${reset} ${verde}[NOVO]                ${verde}| ${reset}  ${amarelo}[ 90 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 68 ]${reset} - ${branco}Browserless ${verde}[2/4]${reset} ${verde}[NOVO]               ${verde}| ${reset}  ${amarelo}[ 91 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e ""
    echo -e ""
    echo -e "${branco}<-- Digite ${amarelo}P1 ${branco}para ir para pagina 1             ${amarelo}|${branco}              Digite ${amarelo}P2${branco} para ir para pagina 2 -->${reset}"
    echo -e ""
...
recursos() {
    ...
    if [[ $vcpu_disponivel -ge $vcpu_requerido && $ram_disponivel -ge $ram_requerido ]]; then
        ...
        clear
        erro_msg
        echo -e "Ops, parece que o seu servidor não atende os requisitos minimos dessa aplicação."
        echo -e "Esse serviço precisa de \e[32m$vcpu_requerido vCPU${reset} e \e[32m$ram_requerido Gb Ram${reset}."
        echo -e "Atualmente seu servidor possui apenas: \e[32m$vcpu_disponivel vCPU${reset} com \e[32m$ram_disponivel GbRam${reset}."
        echo -e "Realize um upgrade no seu servidor para poder instalar esse recurso."
...
## Baixando imagens:
pull atendai/evolution-api:latest
...
STACK_NAME="evolution_oriondesign${1:+_$1}"
stack_editavel # > /dev/null 2>&1
...
if [ $? -eq 0 ]; then
    echo "1/7 - [ OK ] - Copiando arquivo php.ini"
else
    echo "1/7 - [ OFF ] - Copiando arquivo php.ini"
fi
...
## --------------------------- ORION --------------------------- ##
  ...
  dify${1:+_$1}_api:
    image: langgenius/dify-api:0.15.3 ## Versão do Dify
...
## --------------------------- ORION --------------------------- ## 
  ...
  dify${1:+_$1}_web:
    image: langgenius/dify-web:0.15.3 ## Versão do Dify
...
## Baixando imagens:
pull langgenius/dify-api:0.15.3 langgenius/dify-web:0.15.3 langgenius/dify-sandbox:0.2.10 semitechnologies/weaviate:latest

## Usa o serviço wait_dify para verificar se o serviço esta online
wait_stack dify${1:+_$1}_dify${1:+_$1}_api dify${1:+_$1}_dify${1:+_$1}_worker dify${1:+_$1}_dify${1:+_$1}_web dify${1:+_$1}_dify${1:+_$1}_sandbox dify${1:+_$1}_dify${1:+_$1}_weaviate
...
## Mensagem de Passo
echo -e "\e[97m• INICIANDO A INSTALAÇÃO DO KRAYIN CRM \e[33m[1/3]\e[0m"
echo ""
sleep 1
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/10\e[0m"
    echo -en "\e[33mDigite o nome do usuario administrador (ex: Orion): \e[0m" && read -r nome_adm_planka
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/2\e[0m"
    echo -en "\e[33mDigite o dominio para o Front do WPPConnect (ex: wppconnect.oriondesign.art.br): \e[0m" && read -r url_wppconnect_front
    echo ""
  
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/2\e[0m"
    echo -en "\e[33mDigite o dominio para a API do WPPConnect (ex: wpp.oriondesign.art.br): \e[0m" && read -r url_wppconnect_api
    echo ""
    ...
    ## Informação sobre URL do wppconnect
    echo -e "\e[33mNome do usuario:\e[97m $url_wppconnect_api\e[0m"
    echo ""
...
## --------------------------- ORION --------------------------- ##
  ...
  wppconnect${1:+_$1}_api:
    ...
    deploy:
      ...
      labels:
      - traefik.enable=1
      - traefik.http.routers.wppconnect${1:+_$1}_api.rule=Host(\`$url_wppconnect_api\`) ## Url do wppconnect API
...
## --------------------------- ORION --------------------------- ##
  ...
  wppconnect${1:+_$1}_front:
    image: wppconnect-front:latest
    ...
    deploy:
      ...
      labels:
      - traefik.enable=1
      - traefik.http.routers.wppconnect${1:+_$1}_front.rule=Host(\`$url_wppconnect_front\`) ## Url do wppconnect API
      - traefik.http.routers.wppconnect${1:+_$1}_front.entrypoints=websecure
      - traefik.http.routers.wppconnect${1:+_$1}_front.priority=1
      - traefik.http.routers.wppconnect${1:+_$1}_front.tls.certresolver=letsencryptresolver
      - traefik.http.routers.wppconnect${1:+_$1}_front.service=wppconnect${1:+_$1}_front
      - traefik.http.services.wppconnect${1:+_$1}_front.loadbalancer.server.port=3000
      - traefik.http.services.wppconnect${1:+_$1}_front.loadbalancer.passHostHeader=true
...
## Baixando imagens:
pull wppconnect/server-cli:latest wppconnect-front:latest

## Usa o serviço wait_wppconnect para verificar se o serviço esta online
wait_stack wppconnect${1:+_$1}_wppconnect${1:+_$1}_api wppconnect${1:+_$1}_wppconnect${1:+_$1}_front
...
Dominio Front: https://$url_wppconnect_front

Dominio API: https://$url_wppconnect_api
...
echo -e "\e[33mDominio Front:\e[97m https://$url_wppconnect_front\e[0m"
echo ""

echo -e "\e[33mDominio API:\e[97m https://$url_wppconnect_api\e[0m"
...
## --------------------------- ORION --------------------------- ##
  ...
  erpnext${1:+_$1}_frontend:
    ...
    environment:
      ...
      - SOCKETIO=frappe_websocket:9000
...
STACK_NAME="erpnext${1:+_$1}${1:+_$1}"
stack_editavel # > /dev/null 2>&1
...
docker exec -it $(docker ps -qf "name=frappe_backend") bash -c "bench new-site 72.ryze.chat --mariadb-root-password=$DB_PASSWORD --admin-password=$senha_frappe --install-app erpnext"
...
## Mensagem de Passo
echo -e "\e[97m• INICIANDO A INSTALAÇÃO DO WISEMAPPING \e[33m[1/3]\e[0m"
echo ""
sleep 1
...
while true; do
    ...
    case $opcao1 in
        ...
        69|Frappe|frappe|FRAPPE) 
            ...
            if verificar_docker_e_portainer_traefik; then
                ## INICIO TOKEN
                STACK_NAME="frappe${opcao2:+_$opcao2}"
                if grep -q "Token: .\+" /root/dados_vps/dados_portainer; then
